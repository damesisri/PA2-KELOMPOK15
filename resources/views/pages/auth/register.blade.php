                        ...
                        <div class="login-main">
                            <form class="theme-form" id="form_login">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="fullname" required="" placeholder="Masukkan Username Anda">
                                </div>
                                <div class="form-group">
                                ...
                                <p class="mt-4 mb-0">Already have an account?<a class="ms-2" href="{{route('auth.index')}}">Sign
                                        in</a></p>
                            </form>
                        </div>
                    </div>
