                                                    ...
                                                    <div class="list-box">
                                                        ...
                                                        <div class="list-content">
                                                            <div>
                                                                ...
                                                                <p class="hotel-info">Harga : {{ number_format($hotel->price) }}</p>
    
                                                                <p class="hotel-info">Kategori : {{ $hotel->category }}</p>
    
                                                                <p class="hotel-info">Deskripsi : {{ $hotel->description }}</p>
    
                                                                <div class="facility-icon">
                                                                    <div class="facility-box">
                                                                        <span>Stock : {{ $hotel->stock }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
