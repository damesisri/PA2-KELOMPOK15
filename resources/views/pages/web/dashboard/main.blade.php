        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"
                    ...
                    <img src="{{ asset('assets-user/images/slides/banenr-img1.jpg') }}" alt=""
                    ...
                    <div class="tp-caption grey_heavy_72 customin tp-resizeme rs-parallaxlevel-10" data-x="center"
                        ...
                        style="font-size:72px; z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Art
                        of Cooking
                    </div>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"
                    ...
                    <img src="{{ asset('assets-user/images/slides/banenr-img2.jpg') }}" alt=""
                        data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"
                    ...
                    <img src="{{ asset('assets-user/images/slides/banenr-img3.jpg') }}" alt=""
                        data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    ...
                    <div class="col-md-12">
                        <div class="main-title">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor at tellus
                                feugiat congue quis ut nunc. Semper ac dolor vitae accumsan. interdum hendrerit lacinia.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="our-story">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('assets-user/images/our-story.jpg') }}" alt="">
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="event-detail">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <img src="{{ asset('assets-user/images/event-img.jpg') }}" alt="">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="event-text">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                            ...
                                            veniam... <a href="event-detail.html">Read More</a></p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="booking-form">
                                    ...
                                    <p class="success" id="reserv_success_msg" style="display:none;">Thank You! We
                                        will contact you shortly.</p>

                                    <form name="reserv_form" id="reserv_form" method="post"
                                        ...
                                        <div class="col-md-6">
                                            <div class="field">
                                                <select class="basic-example" name="reserv_persons"
                                                    id="reserv_persons">
                        ...
                        <div class="row">
                            <div class="span12">
                                ...
                                <div id="owl-demo" class="owl-carousel">
                                    ...
                                    <div class="post item">
                                        <img class="lazyOwl" src="{{ asset('assets-user/images/news-img1.jpg') }}"
                                            alt="">
                                        <div class="detail">
                                    ...
                                    <div class="post item">
                                        <img class="lazyOwl" src="{{ asset('assets-user/images/news-img2.jpg') }}"
                                            alt="">
                                        <div class="detail">
                                    ...
                                    <div class="post item">
                                        <img class="lazyOwl" src="{{ asset('assets-user/images/news-img3.jpg') }}"
                                            alt="">
                                        <div class="detail">
                                    ...
                                    <div class="post item">
                                        <img class="lazyOwl" src="{{ asset('assets-user/images/news-img4.jpg') }}"
                                            alt="">
                                        <div class="detail">
                                            <img src="images/news-cheff2.jpg" alt="">
                                    ...
                                    <div class="post item">
                                        <img class="lazyOwl" src="{{ asset('assets-user/images/news-img5.jpg') }}"
                                            alt="">
                                        <div class="detail">
                                            <img src="images/news-cheff1.jpg" alt="">
